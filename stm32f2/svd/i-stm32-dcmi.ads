...
package Interfaces.STM32.DCMI is
   ...
   subtype CR_CAPTURE_Field is Interfaces.STM32.Bit;
   subtype CR_CM_Field is Interfaces.STM32.Bit;
   subtype CR_CROP_Field is Interfaces.STM32.Bit;
   subtype CR_JPEG_Field is Interfaces.STM32.Bit;
   subtype CR_ESS_Field is Interfaces.STM32.Bit;
   subtype CR_PCKPOL_Field is Interfaces.STM32.Bit;
   subtype CR_HSPOL_Field is Interfaces.STM32.Bit;
   subtype CR_VSPOL_Field is Interfaces.STM32.Bit;
   subtype CR_FCRC_Field is Interfaces.STM32.UInt2;
   subtype CR_EDM_Field is Interfaces.STM32.UInt2;
   ...
   subtype SR_HSYNC_Field is Interfaces.STM32.Bit;
   subtype SR_VSYNC_Field is Interfaces.STM32.Bit;
   subtype SR_FNE_Field is Interfaces.STM32.Bit;
   ...
   subtype RIS_FRAME_RIS_Field is Interfaces.STM32.Bit;
   subtype RIS_OVR_RIS_Field is Interfaces.STM32.Bit;
   subtype RIS_ERR_RIS_Field is Interfaces.STM32.Bit;
   subtype RIS_VSYNC_RIS_Field is Interfaces.STM32.Bit;
   subtype RIS_LINE_RIS_Field is Interfaces.STM32.Bit;
   ...
   subtype IER_FRAME_IE_Field is Interfaces.STM32.Bit;
   subtype IER_OVR_IE_Field is Interfaces.STM32.Bit;
   subtype IER_ERR_IE_Field is Interfaces.STM32.Bit;
   subtype IER_VSYNC_IE_Field is Interfaces.STM32.Bit;
   subtype IER_LINE_IE_Field is Interfaces.STM32.Bit;
   ...
   subtype MIS_FRAME_MIS_Field is Interfaces.STM32.Bit;
   subtype MIS_OVR_MIS_Field is Interfaces.STM32.Bit;
   subtype MIS_ERR_MIS_Field is Interfaces.STM32.Bit;
   subtype MIS_VSYNC_MIS_Field is Interfaces.STM32.Bit;
   subtype MIS_LINE_MIS_Field is Interfaces.STM32.Bit;
   ...
   subtype ICR_FRAME_ISC_Field is Interfaces.STM32.Bit;
   subtype ICR_OVR_ISC_Field is Interfaces.STM32.Bit;
   subtype ICR_ERR_ISC_Field is Interfaces.STM32.Bit;
   subtype ICR_VSYNC_ISC_Field is Interfaces.STM32.Bit;
   subtype ICR_LINE_ISC_Field is Interfaces.STM32.Bit;
   ...
   subtype ESCR_FSC_Field is Interfaces.STM32.Byte;
   subtype ESCR_LSC_Field is Interfaces.STM32.Byte;
   subtype ESCR_LEC_Field is Interfaces.STM32.Byte;
   subtype ESCR_FEC_Field is Interfaces.STM32.Byte;
   ...
   subtype ESUR_FSU_Field is Interfaces.STM32.Byte;
   subtype ESUR_LSU_Field is Interfaces.STM32.Byte;
   subtype ESUR_LEU_Field is Interfaces.STM32.Byte;
   subtype ESUR_FEU_Field is Interfaces.STM32.Byte;
   ...
   subtype CWSTRT_HOFFCNT_Field is Interfaces.STM32.UInt14;
   subtype CWSTRT_VST_Field is Interfaces.STM32.UInt13;
   ...
   subtype CWSIZE_CAPCNT_Field is Interfaces.STM32.UInt14;
   subtype CWSIZE_VLINE_Field is Interfaces.STM32.UInt14;
   ...
   subtype DR_Byte_Element is Interfaces.STM32.Byte;
   ...
   type DCMI_Peripheral is record
      ...
      --  raw interrupt status register
      RIS    : aliased RIS_Register with Volatile_Full_Access;
      --  interrupt enable register
      IER    : aliased IER_Register with Volatile_Full_Access;
      --  masked interrupt status register
      MIS    : aliased MIS_Register with Volatile_Full_Access;
      --  interrupt clear register
      ICR    : aliased ICR_Register with Volatile_Full_Access;
      --  embedded synchronization code register
      ESCR   : aliased ESCR_Register with Volatile_Full_Access;
      --  embedded synchronization unmask register
      ESUR   : aliased ESUR_Register with Volatile_Full_Access;
      --  crop window start
      CWSTRT : aliased CWSTRT_Register with Volatile_Full_Access;
      --  crop window size
      CWSIZE : aliased CWSIZE_Register with Volatile_Full_Access;
      --  data register
      DR     : aliased DR_Register with Volatile_Full_Access;
   end record
     with Volatile;
