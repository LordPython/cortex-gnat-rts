...
package Interfaces.STM32.FLASH is
   ...
   type FLASH_Peripheral is record
      --  Flash access control register
      ACR     : aliased ACR_Register with Volatile_Full_Access;
      --  Flash key register
      KEYR    : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  Flash option key register
      OPTKEYR : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  Status register
      SR      : aliased SR_Register with Volatile_Full_Access;
      --  Control register
      CR      : aliased CR_Register with Volatile_Full_Access;
      --  Flash option control register
      OPTCR   : aliased OPTCR_Register with Volatile_Full_Access;
   end record
     with Volatile;
