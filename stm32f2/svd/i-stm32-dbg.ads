...
package Interfaces.STM32.DBG is
   ...
   subtype DBGMCU_APB1_FZ_DBG_TIM6_STOP_Field is Interfaces.STM32.Bit;
   subtype DBGMCU_APB1_FZ_DBG_TIM7_STOP_Field is Interfaces.STM32.Bit;
   subtype DBGMCU_APB1_FZ_DBG_TIM12_STOP_Field is Interfaces.STM32.Bit;
   subtype DBGMCU_APB1_FZ_DBG_TIM13_STOP_Field is Interfaces.STM32.Bit;
   subtype DBGMCU_APB1_FZ_DBG_TIM14_STOP_Field is Interfaces.STM32.Bit;
   ...
   subtype DBGMCU_APB1_FZ_DBG_J2C1_SMBUS_TIMEOUT_Field is Interfaces.STM32.Bit;
   subtype DBGMCU_APB1_FZ_DBG_J2C2_SMBUS_TIMEOUT_Field is Interfaces.STM32.Bit;
   subtype DBGMCU_APB1_FZ_DBG_J2C3SMBUS_TIMEOUT_Field is Interfaces.STM32.Bit;
   subtype DBGMCU_APB1_FZ_DBG_CAN1_STOP_Field is Interfaces.STM32.Bit;
   subtype DBGMCU_APB1_FZ_DBG_CAN2_STOP_Field is Interfaces.STM32.Bit;
   ...
   subtype DBGMCU_APB2_FZ_DBG_TIM8_STOP_Field is Interfaces.STM32.Bit;
   ...
   type DBG_Peripheral is record
      --  IDCODE
      DBGMCU_IDCODE  : aliased DBGMCU_IDCODE_Register with Volatile_Full_Access;
      --  Control Register
      DBGMCU_CR      : aliased DBGMCU_CR_Register with Volatile_Full_Access;
      --  Debug MCU APB1 Freeze registe
      DBGMCU_APB1_FZ : aliased DBGMCU_APB1_FZ_Register with Volatile_Full_Access;
      --  Debug MCU APB2 Freeze registe
      DBGMCU_APB2_FZ : aliased DBGMCU_APB2_FZ_Register with Volatile_Full_Access;
   end record
     with Volatile;
