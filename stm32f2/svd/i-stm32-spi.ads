...
package Interfaces.STM32.SPI is
   ...
   type SPI_Peripheral is record
      ...
      --  CRC polynomial register
      CRCPR   : aliased CRCPR_Register with Volatile_Full_Access;
      --  RX CRC register
      RXCRCR  : aliased RXCRCR_Register with Volatile_Full_Access;
      --  TX CRC register
      TXCRCR  : aliased TXCRCR_Register with Volatile_Full_Access;
      --  I2S configuration register
      I2SCFGR : aliased I2SCFGR_Register with Volatile_Full_Access;
      --  I2S prescaler register
      I2SPR   : aliased I2SPR_Register with Volatile_Full_Access;
   end record
     with Volatile;
