...
package Interfaces.STM32.USB_OTG_FS is
   ...
   type OTG_FS_DEVICE_Peripheral is record
      --  OTG_FS device configuration register (OTG_FS_DCFG)
      FS_DCFG     : aliased FS_DCFG_Register with Volatile_Full_Access;
      --  OTG_FS device control register (OTG_FS_DCTL)
      FS_DCTL     : aliased FS_DCTL_Register with Volatile_Full_Access;
      --  OTG_FS device status register (OTG_FS_DSTS)
      FS_DSTS     : aliased FS_DSTS_Register with Volatile_Full_Access;
      --  OTG_FS device IN endpoint common interrupt mask register
      --  (OTG_FS_DIEPMSK)
      FS_DIEPMSK  : aliased FS_DIEPMSK_Register with Volatile_Full_Access;
      --  OTG_FS device OUT endpoint common interrupt mask register
      --  (OTG_FS_DOEPMSK)
      FS_DOEPMSK  : aliased FS_DOEPMSK_Register with Volatile_Full_Access;
      --  OTG_FS device all endpoints interrupt register (OTG_FS_DAINT)
      FS_DAINT    : aliased FS_DAINT_Register with Volatile_Full_Access;
      --  OTG_FS all endpoints interrupt mask register (OTG_FS_DAINTMSK)
      FS_DAINTMSK : aliased FS_DAINTMSK_Register with Volatile_Full_Access;
      --  OTG_FS device VBUS discharge time register
      DVBUSDIS    : aliased DVBUSDIS_Register with Volatile_Full_Access;
      --  OTG_FS device VBUS pulsing time register
      DVBUSPULSE  : aliased DVBUSPULSE_Register with Volatile_Full_Access;
      --  OTG_FS device IN endpoint FIFO empty interrupt mask register
      DIEPEMPMSK  : aliased DIEPEMPMSK_Register with Volatile_Full_Access;
      --  OTG_FS device control IN endpoint 0 control register
      --  (OTG_FS_DIEPCTL0)
      FS_DIEPCTL0 : aliased FS_DIEPCTL0_Register with Volatile_Full_Access;
      --  device endpoint-x interrupt register
      DIEPINT0    : aliased DIEPINT_Register with Volatile_Full_Access;
      --  device endpoint-0 transfer size register
      DIEPTSIZ0   : aliased DIEPTSIZ0_Register with Volatile_Full_Access;
      --  OTG_FS device IN endpoint transmit FIFO status register
      DTXFSTS0    : aliased DTXFSTS_Register with Volatile_Full_Access;
      --  OTG device endpoint-1 control register
      DIEPCTL1    : aliased DIEPCTL1_Register with Volatile_Full_Access;
      --  device endpoint-1 interrupt register
      DIEPINT1    : aliased DIEPINT_Register with Volatile_Full_Access;
      --  device endpoint-1 transfer size register
      DIEPTSIZ1   : aliased DIEPTSIZ_Register with Volatile_Full_Access;
      --  OTG_FS device IN endpoint transmit FIFO status register
      DTXFSTS1    : aliased DTXFSTS_Register with Volatile_Full_Access;
      --  OTG device endpoint-2 control register
      DIEPCTL2    : aliased DIEPCTL_Register with Volatile_Full_Access;
      --  device endpoint-2 interrupt register
      DIEPINT2    : aliased DIEPINT_Register with Volatile_Full_Access;
      --  device endpoint-2 transfer size register
      DIEPTSIZ2   : aliased DIEPTSIZ_Register with Volatile_Full_Access;
      --  OTG_FS device IN endpoint transmit FIFO status register
      DTXFSTS2    : aliased DTXFSTS_Register with Volatile_Full_Access;
      --  OTG device endpoint-3 control register
      DIEPCTL3    : aliased DIEPCTL_Register with Volatile_Full_Access;
      --  device endpoint-3 interrupt register
      DIEPINT3    : aliased DIEPINT_Register with Volatile_Full_Access;
      --  device endpoint-3 transfer size register
      DIEPTSIZ3   : aliased DIEPTSIZ_Register with Volatile_Full_Access;
      --  OTG_FS device IN endpoint transmit FIFO status register
      DTXFSTS3    : aliased DTXFSTS_Register with Volatile_Full_Access;
      --  device endpoint-0 control register
      DOEPCTL0    : aliased DOEPCTL0_Register with Volatile_Full_Access;
      --  device endpoint-0 interrupt register
      DOEPINT0    : aliased DOEPINT_Register with Volatile_Full_Access;
      --  device OUT endpoint-0 transfer size register
      DOEPTSIZ0   : aliased DOEPTSIZ0_Register with Volatile_Full_Access;
      --  device endpoint-1 control register
      DOEPCTL1    : aliased DOEPCTL_Register with Volatile_Full_Access;
      --  device endpoint-1 interrupt register
      DOEPINT1    : aliased DOEPINT_Register with Volatile_Full_Access;
      --  device OUT endpoint-1 transfer size register
      DOEPTSIZ1   : aliased DOEPTSIZ_Register with Volatile_Full_Access;
      --  device endpoint-2 control register
      DOEPCTL2    : aliased DOEPCTL_Register with Volatile_Full_Access;
      --  device endpoint-2 interrupt register
      DOEPINT2    : aliased DOEPINT_Register with Volatile_Full_Access;
      --  device OUT endpoint-2 transfer size register
      DOEPTSIZ2   : aliased DOEPTSIZ_Register with Volatile_Full_Access;
      --  device endpoint-3 control register
      DOEPCTL3    : aliased DOEPCTL_Register with Volatile_Full_Access;
      --  device endpoint-3 interrupt register
      DOEPINT3    : aliased DOEPINT_Register with Volatile_Full_Access;
      --  device OUT endpoint-3 transfer size register
      DOEPTSIZ3   : aliased DOEPTSIZ_Register with Volatile_Full_Access;
   end record
     with Volatile;
   ...
   is record
      --  OTG_FS control and status register (OTG_FS_GOTGCTL)
      FS_GOTGCTL          : aliased FS_GOTGCTL_Register with Volatile_Full_Access;
      --  OTG_FS interrupt register (OTG_FS_GOTGINT)
      FS_GOTGINT          : aliased FS_GOTGINT_Register with Volatile_Full_Access;
      --  OTG_FS AHB configuration register (OTG_FS_GAHBCFG)
      FS_GAHBCFG          : aliased FS_GAHBCFG_Register with Volatile_Full_Access;
      --  OTG_FS USB configuration register (OTG_FS_GUSBCFG)
      FS_GUSBCFG          : aliased FS_GUSBCFG_Register with Volatile_Full_Access;
      --  OTG_FS reset register (OTG_FS_GRSTCTL)
      FS_GRSTCTL          : aliased FS_GRSTCTL_Register with Volatile_Full_Access;
      --  OTG_FS core interrupt register (OTG_FS_GINTSTS)
      FS_GINTSTS          : aliased FS_GINTSTS_Register with Volatile_Full_Access;
      --  OTG_FS interrupt mask register (OTG_FS_GINTMSK)
      FS_GINTMSK          : aliased FS_GINTMSK_Register with Volatile_Full_Access;
      --  OTG_FS Receive FIFO size register (OTG_FS_GRXFSIZ)
      FS_GRXFSIZ          : aliased FS_GRXFSIZ_Register with Volatile_Full_Access;
      --  OTG_FS non-periodic transmit FIFO/queue status register
      --  (OTG_FS_GNPTXSTS)
      FS_GNPTXSTS         : aliased FS_GNPTXSTS_Register with Volatile_Full_Access;
      --  OTG_FS general core configuration register (OTG_FS_GCCFG)
      FS_GCCFG            : aliased FS_GCCFG_Register with Volatile_Full_Access;
      --  core ID register
      FS_CID              : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  OTG_FS Host periodic transmit FIFO size register (OTG_FS_HPTXFSIZ)
      FS_HPTXFSIZ         : aliased FS_HPTXFSIZ_Register with Volatile_Full_Access;
      --  OTG_FS device IN endpoint transmit FIFO size register
      --  (OTG_FS_DIEPTXF2)
      FS_DIEPTXF1         : aliased FS_DIEPTXF_Register with Volatile_Full_Access;
      --  OTG_FS device IN endpoint transmit FIFO size register
      --  (OTG_FS_DIEPTXF3)
      FS_DIEPTXF2         : aliased FS_DIEPTXF_Register with Volatile_Full_Access;
      --  OTG_FS device IN endpoint transmit FIFO size register
      --  (OTG_FS_DIEPTXF4)
      FS_DIEPTXF3         : aliased FS_DIEPTXF_Register with Volatile_Full_Access;
      case Discriminent is
         when Device =>
            --  OTG_FS Receive status debug read(Device mode)
            FS_GRXSTSR_Device : aliased FS_GRXSTSR_Device_Register with Volatile_Full_Access;
            --  OTG_FS non-periodic transmit FIFO size register (Device mode)
            FS_GNPTXFSIZ_Device : aliased FS_GNPTXFSIZ_Device_Register with Volatile_Full_Access;
         when Host =>
            --  OTG_FS Receive status debug read(Host mode)
            FS_GRXSTSR_Host : aliased FS_GRXSTSR_Host_Register with Volatile_Full_Access;
            --  OTG_FS non-periodic transmit FIFO size register (Host mode)
            FS_GNPTXFSIZ_Host : aliased FS_GNPTXFSIZ_Host_Register with Volatile_Full_Access;
      end case;
   end record
   ...
   type OTG_FS_HOST_Peripheral is record
      --  OTG_FS host configuration register (OTG_FS_HCFG)
      FS_HCFG      : aliased FS_HCFG_Register with Volatile_Full_Access;
      --  OTG_FS Host frame interval register
      HFIR         : aliased HFIR_Register with Volatile_Full_Access;
      --  OTG_FS host frame number/frame time remaining register (OTG_FS_HFNUM)
      FS_HFNUM     : aliased FS_HFNUM_Register with Volatile_Full_Access;
      --  OTG_FS_Host periodic transmit FIFO/queue status register
      --  (OTG_FS_HPTXSTS)
      FS_HPTXSTS   : aliased FS_HPTXSTS_Register with Volatile_Full_Access;
      --  OTG_FS Host all channels interrupt register
      HAINT        : aliased HAINT_Register with Volatile_Full_Access;
      --  OTG_FS host all channels interrupt mask register
      HAINTMSK     : aliased HAINTMSK_Register with Volatile_Full_Access;
      --  OTG_FS host port control and status register (OTG_FS_HPRT)
      FS_HPRT      : aliased FS_HPRT_Register with Volatile_Full_Access;
      --  OTG_FS host channel-0 characteristics register (OTG_FS_HCCHAR0)
      FS_HCCHAR0   : aliased FS_HCCHAR_Register with Volatile_Full_Access;
      --  OTG_FS host channel-0 interrupt register (OTG_FS_HCINT0)
      FS_HCINT0    : aliased FS_HCINT_Register with Volatile_Full_Access;
      --  OTG_FS host channel-0 mask register (OTG_FS_HCINTMSK0)
      FS_HCINTMSK0 : aliased FS_HCINTMSK_Register with Volatile_Full_Access;
      --  OTG_FS host channel-0 transfer size register
      FS_HCTSIZ0   : aliased FS_HCTSIZ_Register with Volatile_Full_Access;
      --  OTG_FS host channel-1 characteristics register (OTG_FS_HCCHAR1)
      FS_HCCHAR1   : aliased FS_HCCHAR_Register with Volatile_Full_Access;
      --  OTG_FS host channel-1 interrupt register (OTG_FS_HCINT1)
      FS_HCINT1    : aliased FS_HCINT_Register with Volatile_Full_Access;
      --  OTG_FS host channel-1 mask register (OTG_FS_HCINTMSK1)
      FS_HCINTMSK1 : aliased FS_HCINTMSK_Register with Volatile_Full_Access;
      --  OTG_FS host channel-1 transfer size register
      FS_HCTSIZ1   : aliased FS_HCTSIZ_Register with Volatile_Full_Access;
      --  OTG_FS host channel-2 characteristics register (OTG_FS_HCCHAR2)
      FS_HCCHAR2   : aliased FS_HCCHAR_Register with Volatile_Full_Access;
      --  OTG_FS host channel-2 interrupt register (OTG_FS_HCINT2)
      FS_HCINT2    : aliased FS_HCINT_Register with Volatile_Full_Access;
      --  OTG_FS host channel-2 mask register (OTG_FS_HCINTMSK2)
      FS_HCINTMSK2 : aliased FS_HCINTMSK_Register with Volatile_Full_Access;
      --  OTG_FS host channel-2 transfer size register
      FS_HCTSIZ2   : aliased FS_HCTSIZ_Register with Volatile_Full_Access;
      --  OTG_FS host channel-3 characteristics register (OTG_FS_HCCHAR3)
      FS_HCCHAR3   : aliased FS_HCCHAR_Register with Volatile_Full_Access;
      --  OTG_FS host channel-3 interrupt register (OTG_FS_HCINT3)
      FS_HCINT3    : aliased FS_HCINT_Register with Volatile_Full_Access;
      --  OTG_FS host channel-3 mask register (OTG_FS_HCINTMSK3)
      FS_HCINTMSK3 : aliased FS_HCINTMSK_Register with Volatile_Full_Access;
      --  OTG_FS host channel-3 transfer size register
      FS_HCTSIZ3   : aliased FS_HCTSIZ_Register with Volatile_Full_Access;
      --  OTG_FS host channel-4 characteristics register (OTG_FS_HCCHAR4)
      FS_HCCHAR4   : aliased FS_HCCHAR_Register with Volatile_Full_Access;
      --  OTG_FS host channel-4 interrupt register (OTG_FS_HCINT4)
      FS_HCINT4    : aliased FS_HCINT_Register with Volatile_Full_Access;
      --  OTG_FS host channel-4 mask register (OTG_FS_HCINTMSK4)
      FS_HCINTMSK4 : aliased FS_HCINTMSK_Register with Volatile_Full_Access;
      --  OTG_FS host channel-x transfer size register
      FS_HCTSIZ4   : aliased FS_HCTSIZ_Register with Volatile_Full_Access;
      --  OTG_FS host channel-5 characteristics register (OTG_FS_HCCHAR5)
      FS_HCCHAR5   : aliased FS_HCCHAR_Register with Volatile_Full_Access;
      --  OTG_FS host channel-5 interrupt register (OTG_FS_HCINT5)
      FS_HCINT5    : aliased FS_HCINT_Register with Volatile_Full_Access;
      --  OTG_FS host channel-5 mask register (OTG_FS_HCINTMSK5)
      FS_HCINTMSK5 : aliased FS_HCINTMSK_Register with Volatile_Full_Access;
      --  OTG_FS host channel-5 transfer size register
      FS_HCTSIZ5   : aliased FS_HCTSIZ_Register with Volatile_Full_Access;
      --  OTG_FS host channel-6 characteristics register (OTG_FS_HCCHAR6)
      FS_HCCHAR6   : aliased FS_HCCHAR_Register with Volatile_Full_Access;
      --  OTG_FS host channel-6 interrupt register (OTG_FS_HCINT6)
      FS_HCINT6    : aliased FS_HCINT_Register with Volatile_Full_Access;
      --  OTG_FS host channel-6 mask register (OTG_FS_HCINTMSK6)
      FS_HCINTMSK6 : aliased FS_HCINTMSK_Register with Volatile_Full_Access;
      --  OTG_FS host channel-6 transfer size register
      FS_HCTSIZ6   : aliased FS_HCTSIZ_Register with Volatile_Full_Access;
      --  OTG_FS host channel-7 characteristics register (OTG_FS_HCCHAR7)
      FS_HCCHAR7   : aliased FS_HCCHAR_Register with Volatile_Full_Access;
      --  OTG_FS host channel-7 interrupt register (OTG_FS_HCINT7)
      FS_HCINT7    : aliased FS_HCINT_Register with Volatile_Full_Access;
      --  OTG_FS host channel-7 mask register (OTG_FS_HCINTMSK7)
      FS_HCINTMSK7 : aliased FS_HCINTMSK_Register with Volatile_Full_Access;
      --  OTG_FS host channel-7 transfer size register
      FS_HCTSIZ7   : aliased FS_HCTSIZ_Register with Volatile_Full_Access;
   end record
     with Volatile;
   ...
   type OTG_FS_PWRCLK_Peripheral is record
      --  OTG_FS power and clock gating control register (OTG_FS_PCGCCTL)
      FS_PCGCCTL : aliased FS_PCGCCTL_Register with Volatile_Full_Access;
   end record
     with Volatile;
