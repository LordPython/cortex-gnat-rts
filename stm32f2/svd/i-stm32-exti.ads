...
package Interfaces.STM32.EXTI is
   ...
   type EXTI_Peripheral is record
      --  Interrupt mask register (EXTI_IMR)
      IMR   : aliased IMR_Register with Volatile_Full_Access;
      --  Event mask register (EXTI_EMR)
      EMR   : aliased EMR_Register with Volatile_Full_Access;
      --  Rising Trigger selection register (EXTI_RTSR)
      RTSR  : aliased RTSR_Register with Volatile_Full_Access;
      --  Falling Trigger selection register (EXTI_FTSR)
      FTSR  : aliased FTSR_Register with Volatile_Full_Access;
      --  Software interrupt event register (EXTI_SWIER)
      SWIER : aliased SWIER_Register with Volatile_Full_Access;
      --  Pending register (EXTI_PR)
      PR    : aliased PR_Register with Volatile_Full_Access;
   end record
     with Volatile;
