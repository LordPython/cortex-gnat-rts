...
package Interfaces.STM32.RTC is
   ...
   subtype PRER_PREDIV_S_Field is Interfaces.STM32.UInt13;
   ...
   type RTC_Peripheral is record
      --  time register
      TR     : aliased TR_Register with Volatile_Full_Access;
      --  date register
      DR     : aliased DR_Register with Volatile_Full_Access;
      --  control register
      CR     : aliased CR_Register with Volatile_Full_Access;
      --  initialization and status register
      ISR    : aliased ISR_Register with Volatile_Full_Access;
      --  prescaler register
      PRER   : aliased PRER_Register with Volatile_Full_Access;
      --  wakeup timer register
      WUTR   : aliased WUTR_Register with Volatile_Full_Access;
      --  calibration register
      CALIBR : aliased CALIBR_Register with Volatile_Full_Access;
      --  alarm A register
      ALRMAR : aliased ALRMAR_Register with Volatile_Full_Access;
      --  alarm B register
      ALRMBR : aliased ALRMBR_Register with Volatile_Full_Access;
      --  write protection register
      WPR    : aliased WPR_Register with Volatile_Full_Access;
      --  time stamp time register
      TSTR   : aliased TSTR_Register with Volatile_Full_Access;
      --  time stamp date register
      TSDR   : aliased TSDR_Register with Volatile_Full_Access;
      --  tamper and alternate function configuration register
      TAFCR  : aliased TAFCR_Register with Volatile_Full_Access;
      --  backup register
      BKP0R  : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  backup register
      BKP1R  : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  backup register
      BKP2R  : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  backup register
      BKP3R  : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  backup register
      BKP4R  : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  backup register
      BKP5R  : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  backup register
      BKP6R  : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  backup register
      BKP7R  : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  backup register
      BKP8R  : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  backup register
      BKP9R  : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  backup register
      BKP10R : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  backup register
      BKP11R : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  backup register
      BKP12R : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  backup register
      BKP13R : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  backup register
      BKP14R : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  backup register
      BKP15R : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  backup register
      BKP16R : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  backup register
      BKP17R : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  backup register
      BKP18R : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  backup register
      BKP19R : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
   end record
     with Volatile;
