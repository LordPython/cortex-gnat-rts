...
package Interfaces.STM32.DMA is
   ...
   type DMA_Peripheral is record
      --  low interrupt status register
      LISR   : aliased LISR_Register with Volatile_Full_Access;
      --  high interrupt status register
      HISR   : aliased HISR_Register with Volatile_Full_Access;
      --  low interrupt flag clear register
      LIFCR  : aliased LIFCR_Register with Volatile_Full_Access;
      --  high interrupt flag clear register
      HIFCR  : aliased HIFCR_Register with Volatile_Full_Access;
      --  stream x configuration register
      S0CR   : aliased S0CR_Register with Volatile_Full_Access;
      --  stream x number of data register
      S0NDTR : aliased S0NDTR_Register with Volatile_Full_Access;
      --  stream x peripheral address register
      S0PAR  : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x memory 0 address register
      S0M0AR : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x memory 1 address register
      S0M1AR : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x FIFO control register
      S0FCR  : aliased S0FCR_Register with Volatile_Full_Access;
      --  stream x configuration register
      S1CR   : aliased S1CR_Register with Volatile_Full_Access;
      --  stream x number of data register
      S1NDTR : aliased S1NDTR_Register with Volatile_Full_Access;
      --  stream x peripheral address register
      S1PAR  : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x memory 0 address register
      S1M0AR : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x memory 1 address register
      S1M1AR : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x FIFO control register
      S1FCR  : aliased S1FCR_Register with Volatile_Full_Access;
      --  stream x configuration register
      S2CR   : aliased S2CR_Register with Volatile_Full_Access;
      --  stream x number of data register
      S2NDTR : aliased S2NDTR_Register with Volatile_Full_Access;
      --  stream x peripheral address register
      S2PAR  : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x memory 0 address register
      S2M0AR : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x memory 1 address register
      S2M1AR : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x FIFO control register
      S2FCR  : aliased S2FCR_Register with Volatile_Full_Access;
      --  stream x configuration register
      S3CR   : aliased S3CR_Register with Volatile_Full_Access;
      --  stream x number of data register
      S3NDTR : aliased S3NDTR_Register with Volatile_Full_Access;
      --  stream x peripheral address register
      S3PAR  : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x memory 0 address register
      S3M0AR : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x memory 1 address register
      S3M1AR : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x FIFO control register
      S3FCR  : aliased S3FCR_Register with Volatile_Full_Access;
      --  stream x configuration register
      S4CR   : aliased S4CR_Register with Volatile_Full_Access;
      --  stream x number of data register
      S4NDTR : aliased S4NDTR_Register with Volatile_Full_Access;
      --  stream x peripheral address register
      S4PAR  : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x memory 0 address register
      S4M0AR : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x memory 1 address register
      S4M1AR : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x FIFO control register
      S4FCR  : aliased S4FCR_Register with Volatile_Full_Access;
      --  stream x configuration register
      S5CR   : aliased S5CR_Register with Volatile_Full_Access;
      --  stream x number of data register
      S5NDTR : aliased S5NDTR_Register with Volatile_Full_Access;
      --  stream x peripheral address register
      S5PAR  : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x memory 0 address register
      S5M0AR : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x memory 1 address register
      S5M1AR : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x FIFO control register
      S5FCR  : aliased S5FCR_Register with Volatile_Full_Access;
      --  stream x configuration register
      S6CR   : aliased S6CR_Register with Volatile_Full_Access;
      --  stream x number of data register
      S6NDTR : aliased S6NDTR_Register with Volatile_Full_Access;
      --  stream x peripheral address register
      S6PAR  : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x memory 0 address register
      S6M0AR : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x memory 1 address register
      S6M1AR : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x FIFO control register
      S6FCR  : aliased S6FCR_Register with Volatile_Full_Access;
      --  stream x configuration register
      S7CR   : aliased S7CR_Register with Volatile_Full_Access;
      --  stream x number of data register
      S7NDTR : aliased S7NDTR_Register with Volatile_Full_Access;
      --  stream x peripheral address register
      S7PAR  : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x memory 0 address register
      S7M0AR : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x memory 1 address register
      S7M1AR : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  stream x FIFO control register
      S7FCR  : aliased S7FCR_Register with Volatile_Full_Access;
   end record
     with Volatile;
