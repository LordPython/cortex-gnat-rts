...
package Interfaces.STM32.I2C is
   ...
   type I2C_Peripheral is record
      ...
      --  Own address register 1
      OAR1  : aliased OAR1_Register with Volatile_Full_Access;
      --  Own address register 2
      OAR2  : aliased OAR2_Register with Volatile_Full_Access;
      --  Data register
      DR    : aliased DR_Register with Volatile_Full_Access;
      --  Status register 1
      SR1   : aliased SR1_Register with Volatile_Full_Access;
      --  Status register 2
      SR2   : aliased SR2_Register with Volatile_Full_Access;
      --  Clock control register
      CCR   : aliased CCR_Register with Volatile_Full_Access;
      --  TRISE register
      TRISE : aliased TRISE_Register with Volatile_Full_Access;
   end record
     with Volatile;
