...
package Interfaces.STM32.ADC is
   ...
   subtype CCR_MULT_Field is Interfaces.STM32.UInt5;
   ...
   subtype CDR_DATA_Element is Interfaces.STM32.UInt16;
   ...
   type ADC1_Peripheral is record
      ...
      --  sample time register 1
      SMPR1 : aliased SMPR1_Register with Volatile_Full_Access;
      --  sample time register 2
      SMPR2 : aliased SMPR2_Register with Volatile_Full_Access;
      --  injected channel data offset register x
      JOFR1 : aliased JOFR1_Register with Volatile_Full_Access;
      --  injected channel data offset register x
      JOFR2 : aliased JOFR2_Register with Volatile_Full_Access;
      --  injected channel data offset register x
      JOFR3 : aliased JOFR3_Register with Volatile_Full_Access;
      --  injected channel data offset register x
      JOFR4 : aliased JOFR4_Register with Volatile_Full_Access;
      --  watchdog higher threshold register
      HTR   : aliased HTR_Register with Volatile_Full_Access;
      --  watchdog lower threshold register
      LTR   : aliased LTR_Register with Volatile_Full_Access;
      --  regular sequence register 1
      SQR1  : aliased SQR1_Register with Volatile_Full_Access;
      --  regular sequence register 2
      SQR2  : aliased SQR2_Register with Volatile_Full_Access;
      --  regular sequence register 3
      SQR3  : aliased SQR3_Register with Volatile_Full_Access;
      --  injected sequence register
      JSQR  : aliased JSQR_Register with Volatile_Full_Access;
      --  injected data register x
      JDR1  : aliased JDR_Register with Volatile_Full_Access;
      --  injected data register x
      JDR2  : aliased JDR_Register with Volatile_Full_Access;
      --  injected data register x
      JDR3  : aliased JDR_Register with Volatile_Full_Access;
      --  injected data register x
      JDR4  : aliased JDR_Register with Volatile_Full_Access;
      --  regular data register
   ...
   type ADC_Common_Peripheral is record
      ...
      --  ADC common control register
      CCR : aliased CCR_Register with Volatile_Full_Access;
      --  ADC common regular data register for dual and triple modes
      CDR : aliased CDR_Register with Volatile_Full_Access;
   end record
     with Volatile;
