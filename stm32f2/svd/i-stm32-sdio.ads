...
package Interfaces.STM32.SDIO is
   ...
   type SDIO_Peripheral is record
      --  power control register
      POWER   : aliased POWER_Register with Volatile_Full_Access;
      --  SDI clock control register
      CLKCR   : aliased CLKCR_Register with Volatile_Full_Access;
      --  argument register
      ARG     : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  command register
      CMD     : aliased CMD_Register with Volatile_Full_Access;
      --  command response register
      RESPCMD : aliased RESPCMD_Register with Volatile_Full_Access;
      --  response 1..4 register
      RESP1   : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  response 1..4 register
      RESP2   : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  response 1..4 register
      RESP3   : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  response 1..4 register
      RESP4   : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  data timer register
      DTIMER  : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  data length register
      DLEN    : aliased DLEN_Register with Volatile_Full_Access;
      --  data control register
      DCTRL   : aliased DCTRL_Register with Volatile_Full_Access;
      --  data counter register
      DCOUNT  : aliased DCOUNT_Register with Volatile_Full_Access;
      --  status register
      STA     : aliased STA_Register with Volatile_Full_Access;
      --  interrupt clear register
      ICR     : aliased ICR_Register with Volatile_Full_Access;
      --  mask register
      MASK    : aliased MASK_Register with Volatile_Full_Access;
      --  FIFO counter register
      FIFOCNT : aliased FIFOCNT_Register with Volatile_Full_Access;
      --  data FIFO register
      FIFO    : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
   end record
     with Volatile;
