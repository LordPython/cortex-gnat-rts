...
package Interfaces.STM32.DAC is
   ...
   type DAC_Peripheral is record
      ...
      --  software trigger register
      SWTRIGR : aliased SWTRIGR_Register with Volatile_Full_Access;
      --  channel1 12-bit right-aligned data holding register
      DHR12R1 : aliased DHR12R1_Register with Volatile_Full_Access;
      --  channel1 12-bit left aligned data holding register
      DHR12L1 : aliased DHR12L1_Register with Volatile_Full_Access;
      --  channel1 8-bit right aligned data holding register
      DHR8R1  : aliased DHR8R1_Register with Volatile_Full_Access;
      --  channel2 12-bit right aligned data holding register
      DHR12R2 : aliased DHR12R2_Register with Volatile_Full_Access;
      --  channel2 12-bit left aligned data holding register
      DHR12L2 : aliased DHR12L2_Register with Volatile_Full_Access;
      --  channel2 8-bit right-aligned data holding register
      DHR8R2  : aliased DHR8R2_Register with Volatile_Full_Access;
      --  Dual DAC 12-bit right-aligned data holding register
      DHR12RD : aliased DHR12RD_Register with Volatile_Full_Access;
      --  DUAL DAC 12-bit left aligned data holding register
      DHR12LD : aliased DHR12LD_Register with Volatile_Full_Access;
      --  DUAL DAC 8-bit right aligned data holding register
      DHR8RD  : aliased DHR8RD_Register with Volatile_Full_Access;
      --  channel1 data output register
      DOR1    : aliased DOR1_Register with Volatile_Full_Access;
      --  channel2 data output register
      DOR2    : aliased DOR2_Register with Volatile_Full_Access;
      --  status register
