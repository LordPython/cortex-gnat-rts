...
package Interfaces.STM32.TIM is
   ...
   subtype TIM2_OR_IT4_RMP_Field is Interfaces.STM32.UInt2;
   ...
   subtype TIM5_OR_IT4_RMP_Field is Interfaces.STM32.UInt2;
   ...
   is record
      --  control register 1
      CR1          : aliased CR1_Register with Volatile_Full_Access;
      --  control register 2
      CR2          : aliased CR2_Register with Volatile_Full_Access;
      --  slave mode control register
      SMCR         : aliased SMCR_Register with Volatile_Full_Access;
      --  DMA/Interrupt enable register
      DIER         : aliased DIER_Register with Volatile_Full_Access;
      --  status register
      SR           : aliased SR_Register with Volatile_Full_Access;
      --  event generation register
      EGR          : aliased EGR_Register with Volatile_Full_Access;
      --  capture/compare enable register
      CCER         : aliased CCER_Register with Volatile_Full_Access;
      --  counter
      CNT          : aliased CNT_Register with Volatile_Full_Access;
      --  prescaler
      PSC          : aliased PSC_Register with Volatile_Full_Access;
      --  auto-reload register
      ARR          : aliased ARR_Register with Volatile_Full_Access;
      --  repetition counter register
      RCR          : aliased RCR_Register with Volatile_Full_Access;
      --  capture/compare register 1
      CCR1         : aliased CCR1_Register with Volatile_Full_Access;
      --  capture/compare register 2
      CCR2         : aliased CCR2_Register with Volatile_Full_Access;
      --  capture/compare register 3
      CCR3         : aliased CCR3_Register with Volatile_Full_Access;
      --  capture/compare register 4
      CCR4         : aliased CCR4_Register with Volatile_Full_Access;
      --  break and dead-time register
      BDTR         : aliased BDTR_Register with Volatile_Full_Access;
      --  DMA control register
      DCR          : aliased DCR_Register with Volatile_Full_Access;
      --  DMA address for full transfer
      DMAR         : aliased DMAR_Register with Volatile_Full_Access;
      case Discriminent is
         when Output =>
            --  capture/compare mode register (output mode)
            CCMR1_Output : aliased CCMR1_Output_Register with Volatile_Full_Access;
            --  capture/compare mode register (output mode)
            CCMR2_Output : aliased CCMR2_Output_Register with Volatile_Full_Access;
         when Input =>
            --  capture/compare mode register 1 (input mode)
            CCMR1_Input : aliased CCMR1_Input_Register with Volatile_Full_Access;
            --  capture/compare mode register 2 (input mode)
            CCMR2_Input : aliased CCMR2_Input_Register with Volatile_Full_Access;
      end case;
   end record
   ...
   is record
      ...
      CR1          : aliased CR1_Register with Volatile_Full_Access;
      --  control register 2
      CR2          : aliased CR2_Register_1 with Volatile_Full_Access;
      --  slave mode control register
      SMCR         : aliased SMCR_Register with Volatile_Full_Access;
      --  DMA/Interrupt enable register
      DIER         : aliased DIER_Register_1 with Volatile_Full_Access;
      --  status register
      SR           : aliased SR_Register_1 with Volatile_Full_Access;
      --  event generation register
      EGR          : aliased EGR_Register_1 with Volatile_Full_Access;
      --  capture/compare enable register
      CCER         : aliased CCER_Register_1 with Volatile_Full_Access;
      --  counter
      CNT          : aliased CNT_Register_1 with Volatile_Full_Access;
      --  prescaler
      PSC          : aliased PSC_Register with Volatile_Full_Access;
      --  auto-reload register
      ARR          : aliased ARR_Register_1 with Volatile_Full_Access;
      --  capture/compare register 1
      CCR1         : aliased CCR1_Register_1 with Volatile_Full_Access;
      --  capture/compare register 2
      CCR2         : aliased CCR2_Register_1 with Volatile_Full_Access;
      --  capture/compare register 3
      CCR3         : aliased CCR3_Register_1 with Volatile_Full_Access;
      --  capture/compare register 4
      CCR4         : aliased CCR4_Register_1 with Volatile_Full_Access;
      --  DMA control register
      DCR          : aliased DCR_Register with Volatile_Full_Access;
      --  DMA address for full transfer
      DMAR         : aliased DMAR_Register with Volatile_Full_Access;
      --  TIM2 option register
      TIM2_OR      : aliased TIM2_OR_Register with Volatile_Full_Access;
      case Discriminent is
         when Output =>
            --  capture/compare mode register 1 (output mode)
            CCMR1_Output : aliased CCMR1_Output_Register with Volatile_Full_Access;
         ...
         when Input =>
            --  capture/compare mode register 1 (input mode)
            CCMR1_Input : aliased CCMR1_Input_Register_1 with Volatile_Full_Access;
            --  capture/compare mode register 2 (input mode)
            CCMR2_Input : aliased CCMR2_Input_Register with Volatile_Full_Access;
      end case;
   end record
   ...
   is record
      ...
      DMAR         : aliased DMAR_Register with Volatile_Full_Access;
      --  TIM5 option register
      TIM5_OR      : aliased TIM5_OR_Register with Volatile_Full_Access;
      case Discriminent is
         when Output =>
            --  capture/compare mode register 1 (output mode)
            CCMR1_Output : aliased CCMR1_Output_Register with Volatile_Full_Access;
   ...
   type TIM6_Peripheral is record
      --  control register 1
      CR1  : aliased CR1_Register_1 with Volatile_Full_Access;
      --  control register 2
      CR2  : aliased CR2_Register_2 with Volatile_Full_Access;
      --  DMA/Interrupt enable register
      DIER : aliased DIER_Register_2 with Volatile_Full_Access;
      --  status register
      SR   : aliased SR_Register_2 with Volatile_Full_Access;
      --  event generation register
      EGR  : aliased EGR_Register_2 with Volatile_Full_Access;
      --  counter
      CNT  : aliased CNT_Register with Volatile_Full_Access;
      --  prescaler
      PSC  : aliased PSC_Register with Volatile_Full_Access;
   ...
   is record
      --  control register 1
      CR1          : aliased CR1_Register_2 with Volatile_Full_Access;
      --  control register 2
      CR2          : aliased CR2_Register_2 with Volatile_Full_Access;
      --  slave mode control register
      SMCR         : aliased SMCR_Register_1 with Volatile_Full_Access;
      --  DMA/Interrupt enable register
      DIER         : aliased DIER_Register_3 with Volatile_Full_Access;
      --  status register
      SR           : aliased SR_Register_3 with Volatile_Full_Access;
      --  event generation register
      EGR          : aliased EGR_Register_3 with Volatile_Full_Access;
      --  capture/compare enable register
      CCER         : aliased CCER_Register_2 with Volatile_Full_Access;
      --  counter
      CNT          : aliased CNT_Register with Volatile_Full_Access;
      --  prescaler
      PSC          : aliased PSC_Register with Volatile_Full_Access;
      ...
      case Discriminent is
         when Output =>
            --  capture/compare mode register 1 (output mode)
            CCMR1_Output : aliased CCMR1_Output_Register_1 with Volatile_Full_Access;
         when Input =>
            --  capture/compare mode register 1 (input mode)
            CCMR1_Input : aliased CCMR1_Input_Register_2 with Volatile_Full_Access;
      end case;
   end record
     with Unchecked_Union, Volatile;
   ...
   is record
      --  control register 1
      CR1          : aliased CR1_Register_3 with Volatile_Full_Access;
      --  DMA/Interrupt enable register
      DIER         : aliased DIER_Register_4 with Volatile_Full_Access;
      --  status register
      SR           : aliased SR_Register_4 with Volatile_Full_Access;
      --  event generation register
      EGR          : aliased EGR_Register_4 with Volatile_Full_Access;
      --  capture/compare enable register
      CCER         : aliased CCER_Register_3 with Volatile_Full_Access;
      --  counter
      CNT          : aliased CNT_Register with Volatile_Full_Access;
      --  prescaler
      PSC          : aliased PSC_Register with Volatile_Full_Access;
      ...
      CCR1         : aliased CCR1_Register with Volatile_Full_Access;
      --  option register
      OR_k         : aliased OR_Register with Volatile_Full_Access;
      case Discriminent is
         when Output =>
            --  capture/compare mode register (output mode)
            CCMR1_Output : aliased CCMR1_Output_Register_2 with Volatile_Full_Access;
         when Input =>
            --  capture/compare mode register (inputmode)
            CCMR1_Input : aliased CCMR1_Input_Register_3 with Volatile_Full_Access;
      end case;
   end record
     with Unchecked_Union, Volatile;
