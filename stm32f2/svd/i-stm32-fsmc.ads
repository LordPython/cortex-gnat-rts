...
package Interfaces.STM32.FSMC is
   ...
   type FSMC_Peripheral is record
      --  SRAM/NOR-Flash chip-select control register 1
      BCR1  : aliased BCR1_Register with Volatile_Full_Access;
      --  SRAM/NOR-Flash chip-select timing register 1
      BTR1  : aliased BTR_Register with Volatile_Full_Access;
      --  SRAM/NOR-Flash chip-select control register 2
      BCR2  : aliased BCR_Register with Volatile_Full_Access;
      --  SRAM/NOR-Flash chip-select timing register 2
      BTR2  : aliased BTR_Register with Volatile_Full_Access;
      --  SRAM/NOR-Flash chip-select control register 3
      BCR3  : aliased BCR_Register with Volatile_Full_Access;
      --  SRAM/NOR-Flash chip-select timing register 3
      BTR3  : aliased BTR_Register with Volatile_Full_Access;
      --  SRAM/NOR-Flash chip-select control register 4
      BCR4  : aliased BCR_Register with Volatile_Full_Access;
      --  SRAM/NOR-Flash chip-select timing register 4
      BTR4  : aliased BTR_Register with Volatile_Full_Access;
      --  PC Card/NAND Flash control register 2
      PCR2  : aliased PCR_Register with Volatile_Full_Access;
      --  FIFO status and interrupt register 2
      SR2   : aliased SR_Register with Volatile_Full_Access;
      --  Common memory space timing register 2
      PMEM2 : aliased PMEM_Register with Volatile_Full_Access;
      --  Attribute memory space timing register 2
      PATT2 : aliased PATT_Register with Volatile_Full_Access;
      --  ECC result register 2
      ECCR2 : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  PC Card/NAND Flash control register 3
      PCR3  : aliased PCR_Register with Volatile_Full_Access;
      --  FIFO status and interrupt register 3
      SR3   : aliased SR_Register with Volatile_Full_Access;
      --  Common memory space timing register 3
      PMEM3 : aliased PMEM_Register with Volatile_Full_Access;
      --  Attribute memory space timing register 3
      PATT3 : aliased PATT_Register with Volatile_Full_Access;
      --  ECC result register 3
      ECCR3 : aliased Interfaces.STM32.UInt32 with Volatile_Full_Access;
      --  PC Card/NAND Flash control register 4
      PCR4  : aliased PCR_Register with Volatile_Full_Access;
      --  FIFO status and interrupt register 4
      SR4   : aliased SR_Register with Volatile_Full_Access;
      --  Common memory space timing register 4
      PMEM4 : aliased PMEM_Register with Volatile_Full_Access;
      --  Attribute memory space timing register 4
      PATT4 : aliased PATT_Register with Volatile_Full_Access;
      --  I/O space timing register 4
      PIO4  : aliased PIO4_Register with Volatile_Full_Access;
      --  SRAM/NOR-Flash write timing registers 1
      BWTR1 : aliased BWTR_Register with Volatile_Full_Access;
      --  SRAM/NOR-Flash write timing registers 2
      BWTR2 : aliased BWTR_Register with Volatile_Full_Access;
      --  SRAM/NOR-Flash write timing registers 3
      BWTR3 : aliased BWTR_Register with Volatile_Full_Access;
      --  SRAM/NOR-Flash write timing registers 4
      BWTR4 : aliased BWTR_Register with Volatile_Full_Access;
   end record
     with Volatile;
