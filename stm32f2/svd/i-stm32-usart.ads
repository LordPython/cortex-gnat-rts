...
package Interfaces.STM32.USART is
   ...
   type UART4_Peripheral is record
      ...
      --  Baud rate register
      BRR : aliased BRR_Register with Volatile_Full_Access;
      --  Control register 1
      CR1 : aliased CR1_Register with Volatile_Full_Access;
      --  Control register 2
      CR2 : aliased CR2_Register with Volatile_Full_Access;
      --  Control register 3
      CR3 : aliased CR3_Register with Volatile_Full_Access;
   end record
     with Volatile;
   ...
   type UART5_Peripheral is record
      ...
      CR2 : aliased CR2_Register with Volatile_Full_Access;
      --  Control register 3
      CR3 : aliased CR3_Register_1 with Volatile_Full_Access;
   end record
     with Volatile;
   ...
   type USART_Peripheral is record
      ...
      --  Control register 3
      CR3  : aliased CR3_Register_2 with Volatile_Full_Access;
      --  Guard time and prescaler register
      GTPR : aliased GTPR_Register with Volatile_Full_Access;
   end record
     with Volatile;
