...
package Interfaces.STM32.RCC is
   ...
   type RCC_Peripheral is record
      ...
      --  PLL configuration register
      PLLCFGR    : aliased PLLCFGR_Register with Volatile_Full_Access;
      --  clock configuration register
      CFGR       : aliased CFGR_Register with Volatile_Full_Access;
      --  clock interrupt register
      CIR        : aliased CIR_Register with Volatile_Full_Access;
      --  AHB1 peripheral reset register
      AHB1RSTR   : aliased AHB1RSTR_Register with Volatile_Full_Access;
      --  AHB2 peripheral reset register
      AHB2RSTR   : aliased AHB2RSTR_Register with Volatile_Full_Access;
      --  AHB3 peripheral reset register
      AHB3RSTR   : aliased AHB3RSTR_Register with Volatile_Full_Access;
      --  APB1 peripheral reset register
      APB1RSTR   : aliased APB1RSTR_Register with Volatile_Full_Access;
      --  APB2 peripheral reset register
      APB2RSTR   : aliased APB2RSTR_Register with Volatile_Full_Access;
      --  AHB1 peripheral clock register
      AHB1ENR    : aliased AHB1ENR_Register with Volatile_Full_Access;
      --  AHB2 peripheral clock enable register
      AHB2ENR    : aliased AHB2ENR_Register with Volatile_Full_Access;
      --  AHB3 peripheral clock enable register
      AHB3ENR    : aliased AHB3ENR_Register with Volatile_Full_Access;
      --  APB1 peripheral clock enable register
      APB1ENR    : aliased APB1ENR_Register with Volatile_Full_Access;
      --  APB2 peripheral clock enable register
      APB2ENR    : aliased APB2ENR_Register with Volatile_Full_Access;
      --  AHB1 peripheral clock enable in low power mode register
      AHB1LPENR  : aliased AHB1LPENR_Register with Volatile_Full_Access;
      --  AHB2 peripheral clock enable in low power mode register
      AHB2LPENR  : aliased AHB2LPENR_Register with Volatile_Full_Access;
      --  AHB3 peripheral clock enable in low power mode register
      AHB3LPENR  : aliased AHB3LPENR_Register with Volatile_Full_Access;
      --  APB1 peripheral clock enable in low power mode register
      APB1LPENR  : aliased APB1LPENR_Register with Volatile_Full_Access;
      --  APB2 peripheral clock enabled in low power mode register
      APB2LPENR  : aliased APB2LPENR_Register with Volatile_Full_Access;
      --  Backup domain control register
      BDCR       : aliased BDCR_Register with Volatile_Full_Access;
      --  clock control & status register
      CSR        : aliased CSR_Register with Volatile_Full_Access;
      --  spread spectrum clock generation register
      SSCGR      : aliased SSCGR_Register with Volatile_Full_Access;
      --  PLLI2S configuration register
      PLLI2SCFGR : aliased PLLI2SCFGR_Register with Volatile_Full_Access;
   end record
     with Volatile;
